...
for (
  ...
  console.log(
    `Posição ${controladorFor} valor lido = ${listaArgumentos[controladorFor]} `
  );
}
...
while (controladorWhile < listaArgumentos.length) {
  console.log(
    `Posição ${controladorWhile} valor lido = ${listaArgumentos[controladorWhile]} `
  );
  controladorWhile++;
}
...
do {
  console.log(
    `Posição ${controladorDoWhile} valor lido = ${listaArgumentos[controladorDoWhile]} `
  );
  controladorDoWhile++;
